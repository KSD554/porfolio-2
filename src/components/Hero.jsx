      ...
      <div className="max-w-7xl mt-24 mx-auto items-center flex flex-col md:flex-row gap-16 md:gap-40 justify-between">
        <div className="md:space-y-6 px-4">
          ...
          >
            ...
            d'applications web modernes et performantes. Mon expertise englobe à
            la fois le développement front-end et back-end, me permettant de
            concevoir des solutions complètes et adaptées aux besoins de mes
            clients.
          </motion.p>
          <motion.button
            initial={{ opacity: 0, x: -100 }}
